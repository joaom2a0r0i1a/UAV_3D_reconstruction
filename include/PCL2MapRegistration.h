...
#include <pcl_tools/pcl2map_registration_dynparamConfig.h>
#include <pcl_tools/SrvRegisterPointCloudByName.h>
#include <pcl_tools/SrvRegisterPointCloudOffline.h>
...
private:
  ...
  typedef pcl_tools::pcl2map_registration_dynparamConfig Config;
  ...
  bool callbackSrvRegisterOffline(pcl_tools::SrvRegisterPointCloudOffline::Request &req, pcl_tools::SrvRegisterPointCloudOffline::Response &res);
  bool callbackSrvRegisterPointCloud(pcl_tools::SrvRegisterPointCloudByName::Request &req, pcl_tools::SrvRegisterPointCloudByName::Response &res);
