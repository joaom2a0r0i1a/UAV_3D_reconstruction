...
public:
    ...
    void visualize_edge(const std::shared_ptr<rrt_star_2d::Node> node, const std::string& ns);
    void visualize_path(const std::shared_ptr<rrt_star_2d::Node> node, const std::string& ns);
    void clear_node();
    void clearMarkers();
...
private:
    ...
    // Instances
    GainEvaluator2D segment_evaluator;
