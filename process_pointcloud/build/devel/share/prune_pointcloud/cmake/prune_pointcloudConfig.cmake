...
if("TRUE" STREQUAL "TRUE")
  set(prune_pointcloud_SOURCE_PREFIX /home/joaomendes/workspace1/src/process_pointcloud)
  set(prune_pointcloud_DEVEL_PREFIX /home/joaomendes/workspace1/src/process_pointcloud/build/devel)
  ...
  set(prune_pointcloud_INSTALL_PREFIX /usr/local)
...
if(NOT "/home/joaomendes/workspace1/src/process_pointcloud/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'prune_pointcloud' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/joaomendes/workspace1/src/process_pointcloud/${idir}'.  ${_report}")
    endif()
