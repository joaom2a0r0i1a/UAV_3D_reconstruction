...
def rrt_star(start, goal, obstacles, dim_x=10, dim_y=10, max_iter=1000, step_size=0.1, radius=0.5, tolerance=0.5):
    tree = [Node(start)]
    ...
    ani.save('rrt_star_animation.gif', writer='imagemagick', fps=1000)
    plt.show()
