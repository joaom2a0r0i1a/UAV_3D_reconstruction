...
if(NOT "include;/usr/include/eigen3 " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'Tomas Baca <tomas.baca@fel.cvut.cz>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'motion_planning_python' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '\${prefix}/${idir}'.  ${_report}")
    endif()
...
set(depends "rospy;roscpp;mrs_msgs;mrs_lib;std_srvs;visualization_msgs;trajectory_generation;voxblox_ros;minkindr_conversions;cache_nodes")
