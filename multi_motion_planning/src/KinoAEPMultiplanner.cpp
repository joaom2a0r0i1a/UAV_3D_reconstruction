...
KinoAEPMultiPlanner::KinoAEPMultiPlanner(const ros::NodeHandle& nh, const ros::NodeHandle& nh_private) : nh_(nh), nh_private_(nh_private), voxblox_server_(nh_, nh_private_) {
    ...
    //ss_reevaluate = nh_private_.advertiseService("reevaluate_in", &KinoAEPMultiPlanner::callbackReevaluate, this);
...
/*bool KinoAEPMultiPlanner::callbackReevaluate(cache_nodes::Reevaluate::Request& req, cache_nodes::Reevaluate::Response& res) {
