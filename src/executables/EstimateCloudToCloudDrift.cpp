...
void printHelp() {
  ...
  ROS_ERROR("Usage:");
  ROS_ERROR("   rosrun pcl_tools estimate_cloud_to_cloud_drift source.pcd target.pcd trajectory_in.txt trajectory_out.txt [...]");
...
int main(int argc, char **argv) {
  ...
  // load pcds
  const auto ret_source = pcl_tools::loadPcXYZ(args.pcd_source);
