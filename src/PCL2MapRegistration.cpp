...
bool PCL2MapRegistration::callbackSrvRegisterOffline(pcl_tools::SrvRegisterPointCloudOffline::Request & req,
                                                     pcl_tools::SrvRegisterPointCloudOffline::Response &res) {
  if (!_is_initialized) {
    res.success = false;
...
bool PCL2MapRegistration::callbackSrvRegisterPointCloud(pcl_tools::SrvRegisterPointCloudByName::Request & req,
                                                        pcl_tools::SrvRegisterPointCloudByName::Response &res) {
  if (!_is_initialized) {
    res.success = false;
    res.message = "Registration unitialized.";
    return false;
...
RegistrationOutput PCL2MapRegistration::pcl2map_ndt(RegistrationInput &input) {
  ...
  ROS_INFO("[PCL2MapRegistration] NDT registration run time: %.1f ms", timer.getLifetime());
...
RegistrationOutput PCL2MapRegistration::pcl2map_fpfh(RegistrationInput &input) {
  ...
  ROS_INFO("[PCL2MapRegistration] FPFH registration run time: %.1f ms", timer.getLifetime());
...
RegistrationOutput PCL2MapRegistration::pcl2map_gicp(RegistrationInput &input) {
  ...
  ROS_INFO("[PCL2MapRegistration] GICP registration run time: %.1f ms", timer.getLifetime());
...
RegistrationOutput PCL2MapRegistration::pcl2map_icpn(RegistrationInput &input) {
  ...
  ROS_INFO("[PCL2MapRegistration] ICPN registration run time: %.1f ms", timer.getLifetime());
...
RegistrationOutput PCL2MapRegistration::pcl2map_sicpn(RegistrationInput &input) {
  ...
  ROS_INFO("[PCL2MapRegistration] SICPN registration run time: %.1f ms", timer.getLifetime());
...
PLUGINLIB_EXPORT_CLASS(pcl_tools::PCL2MapRegistration, nodelet::Nodelet);
